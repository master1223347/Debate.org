...
import Lobby from './app/Lobby'; // Adjust path if your file is somewhere else
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/learn/:mode/:promptId" element={<Learn />} />
        ...
        <Route path="/lobby" element={ <Lobby matches={pvpMatches} acceptMatch={acceptMatch} />} />
